        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box">
              ...
              <!-- /.box-header -->
              <form class="form-horizontal" action="<?php echo base_url().'admin/absensi/tambah_absen'?>" method="post">
              <div class="box-body">
        <div class="form-group">
          <label for="inputUserName" class="col-sm-2 control-label">Tanggal</label>
          <div class="col-sm-3">
            <input type="date" name="date" class="form-control" id="inputUserName" required>
          </div>
        </div>
        <button class="btn btn-success btn-flat" ><span class="fa fa-plus"></span> Input Absen</button>
        <br>
        <hr>
                <table id="example1" class="table table-striped" style="font-size:13px;">
                  ...
                  <tbody>
                   ...
                   <tr>
                    ...
                    <input type="hidden" value="<?= $id ?>" name="id<?= $no ?>">
                     <div class="checkbox">
                     <label ><input type="radio" name="status<?= $no ?>" value="0" checked>Masuk</label>
                        <label ><input type="radio" name="status<?= $no ?>" value="1">Alpha</label>
                        <label ><input type="radio" name="status<?= $no ?>" value="2">Ijin</label> 
                    </div>
                  </td>
                </tr>
              <?php endforeach;?>
