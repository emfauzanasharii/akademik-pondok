...
$id=$data->siswa_id;
    ...
    <!-- Main content -->
     ...
     <form class="form-horizontal" action="<?php echo base_url().'admin/rapor/cetak_rapor/'.$id?>" method="post" enctype="multipart/form-data">
      <div class="row ">
        <div class="content">
...
<!--   <a href="<?php echo base_url().'admin/rapor/cetak_rapor/'.$id;?>" class="btn btn-primary btn-block">CETAK RAPOR</a> -->
