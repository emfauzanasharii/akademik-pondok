...
<head>
  ...
  <title>Ponpes Ash-Sholihah | Mapel</title>
              ...
              <table id="example1" class="table table-striped" style="font-size:12px;">
                ...
                <tr>
                  ...
                  <td style="text-align:right;">
                        <a class="btn btn-primary" href="<?php echo base_url().'admin/siswa/nilai_siswa/'.$id ?>" data-target="#ModalEdit<?php echo $id;?>"><span class="fa fa-pencil"> Input Nilai</span></a>
