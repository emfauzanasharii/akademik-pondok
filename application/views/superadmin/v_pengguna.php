                ...
                <tr>
                  ...
                  <?php elseif($pengguna_level=='2'):?>
                   ...
                   <?php elseif($pengguna_level=='4'):?>
                        ...
                        <td>Admin Web Profil</td>
                  <?php else:?>
                        <td>Panita PSB</td>
                  <?php endif;?>
                  <td style="text-align:right;">
                        <a class="btn" data-toggle="modal" data-target="#ModalEdit<?php echo $pengguna_id;?>"><span class="fa fa-pencil"></span></a>
                        <a class="btn" href="<?php echo base_url().'superadmin/pengguna/reset_password/'.$pengguna_id;?>"><span class="fa fa-refresh"></span></a>
...
<!--Modal Tambah Pengguna-->
        <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                   <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <select class="form-control" id="xlevel" name="xlevel" required>
                                                <option value="1">Super Admin</option>
                                                <option value="2">Wali Kelas</option>
                                                <option value="3">Admin</option>
                                                <option value="5">Panitia PSB</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xnama" class="form-control" id="inputEmail3" placeholder="Nama Lengkap" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="texy" name="xusername" class="form-control" id="inputUserName" placeholder="Username" required>
                                        </div>
                                    </div>
                                   <!--  <div class="form-group">
                                        <label for="inputPassword3" class="col-sm-4 control-label">Password</label>
                                        <div class="col-sm-7">
                                            <input type="password" name="xpassword" id="password" class="form-control" id="inputPassword3" placeholder="Password" required>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputPassword4" class="col-sm-4 control-label">Ulangi Password</label>
                                        <div class="col-sm-7">
                                            <input type="password" name="xpassword2" id="ulangipassword" class="form-control" id="inputPassword4" placeholder="Ulangi Password" required>
                                        </div>
                                    </div> -->
                                    <div class="form-group">
            ...
            window.onload = function () {
                ...
                document.getElementById("ulangipassword").onchange = validatePassword;
            }
            function validatePassword(){
                var pass2=document.getElementById("ulangipassword").value;
                var pass1=document.getElementById("password").value;
                if(pass1!=pass2)
                    document.getElementById("ulangipassword").setCustomValidity("Passwords Tidak Sama, Coba Lagi");
                  
                else
                    document.getElementById("ulangipassword").setCustomValidity('');
            }
        </script> -->
                </div>
            </div>
                ...
                <div class="modal-content">
                    ...
                    <?php endif;?>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <?php if($pengguna_level=='1'):?>
                                                <option value="2" selected>Wali Kelas</option>
                                                <option value="3">Admin WEB</option>
                                                <option value="5">Paniti PSB</option>
...
<script type="text/javascript">
  $(function(){
    $("#simpan").click(function(){
      ...
      var ulangi_password=$("#ulangipassword").val();
      if (ulangi_password != password ){
        alert("password Tidak Sama, Silahkan Ulangi Sesuai Password Anda!!!. ");
        retrun false
      }
      retrun true;
    });
